...
class CalendarWidget(RelativeLayout):
    ...
    def prepare_data(self):
        ...
        # Set title
        self.title = "%s - %s" % (self.month_names[self.active_date[1] - 1], self.active_date[2])
    ...
    def get_quarter(self):
        ...
        self.quarter_nums = calc_quarter(self.active_date[2], self.active_date[1])
        self.quarter = get_quarter(self.active_date[2], self.active_date[1])
